...
# ---------- OPTIONAL: ADD SAMPLE DISEASE DATA ----------
sample_data =[
...
for symptom, disease, treatment in sample_data:
    try:
        c.execute("INSERT INTO diseases (disease_name, symptom, treatment) VALUES (?, ?, ?)",
                  (disease, symptom, treatment))
        conn.commit()
        print(f"Disease '{disease}' added successfully.")
    except sqlite3.IntegrityError:
        print(f"Disease '{disease}' already exists.")

# ---------- CLOSE CONNECTION ----------
conn.close()
print("Database setup complete: users.db")
